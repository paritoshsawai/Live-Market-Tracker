...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    title: 'Live Market Analysis - Real-Time Research Dashboard',
    description: 'Real-time research dashboard with live news, markets, infrastructure monitoring, and global risk signals in one workspace.',
    keywords: 'global intelligence, geopolitical dashboard, world news, market data, military bases, nuclear facilities, undersea cables, conflict zones, real-time monitoring, situation awareness, OSINT, flight tracking, AIS ships, earthquake monitor, protest tracker, power outages, oil prices, government spending, polymarket predictions',
    url: 'https://github.com/paritoshsawai',
    siteName: 'Live Market Analysis',
    shortName: 'Live Market Analysis',
    subject: 'Real-Time Market and Global Research Dashboard',
    classification: 'Research Dashboard, Market Analysis Tool, Live Data Workspace',
  ...
  tech: {
    title: 'Live Market Analysis - Tech Research Dashboard',
  ...
  happy: {
    title: 'Live Market Analysis - Good News & Progress',
  ...
  finance: {
    title: 'Live Market Analysis - Markets & Trading Dashboard',
  ...
  commodity: {
    title: 'Live Market Analysis - Commodities & Supply Chain Dashboard',
  ...
  energy: {
    title: 'Live Market Analysis - Global Energy Dashboard',
